...
int main()
{
    ...
    const vector<string> data_list{"gowalla", "yelp2018", "amazon-book", "book"};
    string data_dir = "./";
    ...
    for (const string &data_name : data_list)
    {
        ...
        auto test_data_map = generate_user_item_map(test_data_path);
        ...
        // auto test_data_map_item_user = get_item_user_map(test_data_map, item_num);
